...
fig.update_xaxes(showgrid=True, linecolor='white', tickfont=dict(size=20, color="white"), linewidth=4, mirror=True, title=None, type="category")
fig.update_yaxes(showgrid=True, gridcolor='#44475A', linecolor='white', tickfont=dict(size=17, color="white"), title=dict(text='Desempeño VS Bmk', font=dict(size=30, color='white')),  linewidth=4, mirror=True)
